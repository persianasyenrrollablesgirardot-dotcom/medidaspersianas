  ...
  return (
    <div className="page">
      ...
      <section className="panel export-grid">
        ...
        <button className="export-action" onClick={() => openPrintableReport(projects, catalog, 'client')}><DocumentTextIcon className="icon" /><strong>PDF cliente</strong><span>Sin medidas internas; solo m2 por item.</span></button>
        <button className="export-action" onClick={() => openPrintableReport(projects, catalog, 'supplier')}><DocumentTextIcon className="icon" /><strong>PDF proveedor</strong><span>Variables tecnicas y campos personalizados.</span></button>
        <button className="export-action" onClick={() => openPrintableReport(projects, catalog, 'installer')}><DocumentTextIcon className="icon" /><strong>PDF instalador</strong><span>Montaje, sitio, alertas y fotos tecnicas.</span></button>
        <button className="export-action" onClick={() => openPrintableReport(projects, catalog, 'internal')}><DocumentTextIcon className="icon" /><strong>PDF interno</strong><span>Expediente completo de trabajo.</span></button>
